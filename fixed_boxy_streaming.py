...
LLAMA_MODEL = "gemma-3-4b-it-q4_k_m"
        ...
        self.messages: List[Dict[str, str]] = [
            {
                ...
                "content": (
                    ...
                    "The user may speak English, Russian, or a mix of both. "
                    "You ALWAYS reply in Russian only, using Cyrillic script. "
                    ...
                    "\n\n"
                    "RESPONSE LENGTH: "
                    "Always reply in 2 to 4 short sentences. "
                    "Each sentence must be simple and child-friendly. "
                    "\n\n"
                    "STRICT OUTPUT RULES: "
                    "1. Plain Cyrillic text only. No lists, bullet points, markdown, or emojis. "
                    "2. Never explain grammar using technical linguistic terms. "
                    "3. For translation requests, give the Russian translation and one short example. "
                    "4. If you do not understand, ask one simple clarifying question in Russian. "
                    "5. Never answer in English. "
                ),
            }
        ]
