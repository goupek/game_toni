...
# LLM Limits
# Bumped up to allow for 5-7 full sentences
...
class VoiceAssistant:
        ...
        self.messages: List[Dict] = [
            {"role": "system",
             "content": (
                 ...
                 "3. Simplify your answers for children."
                 "4. DO NOT use asterisks, markdown, emojis, or special symbols. Output plain text only."
             )}
        ]
    ...
    def _respond_with_llm(self, user_text: str):
        ...
        full_response = ""
        current_sentence = ""
        # Added comma and colon to trigger TTS even faster
        sentence_enders = {".", "?", "!", "\n", ",", ":"} 
        ...
        try:
            for chunk in ollama_chat_stream(self.messages):
                ...
                if any(ender in chunk for ender in sentence_enders):
                    ...
                    # --- NEW: Scrub asterisks, underscores, and markdown ---
    ...
    def run_forever(self):
        print("==============================================")
        print("Assistant running (Sentence Streaming Mode).")
